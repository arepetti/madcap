...
class OllamaProvider(LLMProvider):
    ...
    #
    # The Judge deliberately shares the Critic's family rather than the
    # Answerer's. The Judge restates every Answerer turn and issues the
    # verdict, so making it the same model as the Answerer would maximise
    # self-preference bias (the Judge favouring text that matches its own
    # perplexity profile). Keep Judge != Answerer when swapping these tags.
    MODELS = {
